...
//            $table->date('quarter');
    ...
    function promo_pod_refresh() {
        ...
        Schema::create($table_name, function (Blueprint $table) {
            ...
            $table->string('rtl_id')->nullable();
            $table->string('product_name')->nullable();
            $table->double('baseline_pos_sales', 15, 8)->nullable();
            $table->double('baseline_pos_units', 15, 8)->nullable();
            $table->double('baseline_ordered_amount', 15, 8)->nullable();
            $table->double('baseline_ordered_units', 15, 8)->nullable();
            $table->double('during_pos_sales', 15, 8)->nullable();
            $table->double('during_pos_units', 15, 8)->nullable();
            $table->double('during_ordered_amount', 15, 8)->nullable();
            $table->double('during_ordered_units', 15, 8)->nullable();
            $table->double('post_pos_sales', 15, 8)->nullable();
            $table->double('post_pos_units', 15, 8)->nullable();
            $table->double('post_ordered_amount', 15, 8)->nullable();
            $table->double('post_ordered_units', 15, 8)->nullable();
